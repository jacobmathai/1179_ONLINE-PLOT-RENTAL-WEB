...
public class SmsSender {
    ...
    public static String SMSSender(String appString, String password, String mobile, String message, String sendername, String routetype) {
        String rsp = "";
    ...
    public static void main(String[] args) {
        ...
        //8086461927 Thasneem
        //9633272117 Sadiq
        String response = SMSSender("veenasuresh", "veenasuresh", "9633009956", "Abstract Management", "WEBSMS", "2");
        System.out.println(response);
    }
}