 ...
 * @author SUJITH
 */
public class DefaultPlotServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray defaultJSONArray = new SearchModel().getDefaultInfo(bean);
            if(AppConstants.DEBUG){
                System.out.println("Plot Array: " + defaultJSONArray.toJSONString());
            }
