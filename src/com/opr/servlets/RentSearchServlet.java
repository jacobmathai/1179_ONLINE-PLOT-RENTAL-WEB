 ...
 * @author Amritha
 */
public class RentSearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray forRentJson = new SearchModel().getForRentInfo(bean);
            out.println(forRentJson);
        } catch (SQLException ex) {
            RequestDispatcher dp = request.getRequestDispatcher("error.jsp");
