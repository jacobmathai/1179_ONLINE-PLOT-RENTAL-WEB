...
<title>Easy Living | Agent Listing Row Sidebar</title>
...
<div class="container">
    ...
    <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown menu-item-has-children">
                <a href="agent_listing_grid.html" class="current">OUR AGENTS</a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="agent_listing_row_sidebar.html" class="current-sub">Agent Listing Row Sidebar</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="propertyItem">
                        <div class="propertyContent row">
                            ...
                            <a href="agent_single.html" class="propertyImgLink"><img class="propertyImgRow" src="images/agent5.jpg" alt="" /></a>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-7 rowText agentRow">
                            <h4><a href="agent_single.html">Steve Smith</a></h4>
                            <a href="#" class="price"><span style="color:#4a4786;">68</span> Properties Listed</a><br/>
                            <p>123-879-4890<br/>jDoe@easyLiving.com</p>
                ...
                <div class="col-lg-12">
                    <div class="propertyItem">
                        <div class="propertyContent row">
                            <div class="col-lg-5 col-md-5 col-sm-5">
                            <a href="agent_single.html" class="propertyImgLink"><img class="propertyImgRow" src="images/agent6.jpg" alt="" /></a>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-7 rowText agentRow">
                            <h4><a href="agent_single.html">Steve Smith</a></h4>
                            <a href="#" class="price"><span style="color:#4a4786;">102</span> Properties Listed</a><br/>
                            <p>123-879-4890<br/>jDoe@easyLiving.com</p>
                            <p>Lorem ipsum dolor amet, vel nunc vel
                            consectetur adipiscing. Quisque lorem
                            eget ante vel nunc posuere.</p>
                ...
                <div class="col-lg-12">
                    <div class="propertyItem">
                        <div class="propertyContent row">
                            <div class="col-lg-5 col-md-5 col-sm-5">
                            <a href="agent_single.html" class="propertyImgLink"><img class="propertyImgRow" src="images/agent7.jpg" alt="" /></a>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-7 rowText agentRow">
                            <h4><a href="agent_single.html">Steve Smith</a></h4>
                            <a href="#" class="price"><span style="color:#4a4786;">36</span> Properties Listed</a><br/>
                            <p>123-879-4890<br/>jDoe@easyLiving.com</p>
                            <p>Lorem ipsum dolor amet, vel nunc vel
                            consectetur adipiscing. Quisque lorem
                            eget ante vel nunc posuere.</p>
                ...
                <div class="col-lg-12">
                    <div class="propertyItem">
                        <div class="propertyContent row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7 rowText agentRow">
                            <h4><a href="agent_single.html">Steve Smith</a></h4>
                            <a href="#" class="price"><span style="color:#4a4786;">28</span> Properties Listed</a><br/>
                            <p>123-879-4890<br/>jDoe@easyLiving.com</p>
                            <p>Lorem ipsum dolor amet, vel nunc vel
                            consectetur adipiscing. Quisque lorem
                            eget ante vel nunc posuere.</p>
