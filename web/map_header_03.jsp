...
<!--         </ul> -->
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown menu-item-has-children">
                <a href="user_home.jsp" class="current">HOME</a>
                <ul class="dropdown-menu">
                    <li><a href="user_home.jsp" class="current-sub">Home Horizontal Filter</a></li>
                     <li><a href="user_home_map.jsp">Home Map</a></li>
                </ul>
            </li>
            
             <li class="dropdown menu-item-has-children">
                <a href="user_property_list.jsp">RECORD</a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown menu-item-has-children">
                <a href="user_submit_property.jsp">SUBMIT</a>
                <ul class="dropdown-menu">
...
<%
	...
	} else if(bean != null && !bean.getUserType().equals(AppConstants.TYPE_USER)){
		response.sendRedirect("index.jsp");
	} else {
