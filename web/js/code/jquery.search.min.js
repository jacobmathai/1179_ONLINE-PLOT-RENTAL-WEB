...
$('#defaultForm #searchBtn1').click(function(){
    ...
    if(jsonArray.length > 0){
        for(var obj in jsonArray){
            ...
            +'<a class="propertyType" href="user_property_single.jsp?prop_id='+jsonArray[obj].prop_id+'">'+jsonArray[obj].prop_type+'</a><!--FAMILY HOME-->'
            +'<a href="user_property_single.jsp?prop_id='+jsonArray[obj].prop_id+'" class="propertyImgLink">'
            +' <img class="propertyImg" src="SEARCH/photo_01_'+jsonArray[obj].prop_id+'.jpg" alt="" /></a>'
            +'<h4><a href="user_property_single.jsp?prop_id='+jsonArray[obj].prop_id+'">'+jsonArray[obj].prop_title+'</a></h4><!--587 Smith Avenue-->'
...
$('#plotDefaultForm #plotDefaultBtn').click(function(){
    ...
    if(jsonArray.length > 0){
        for(var obj in jsonArray){
            ...
            +'<div class="propertyItem">'
            +'<div class="propertyContent">'
            +'<a class="propertyType" href="user_plot_single.jsp?prop_id='+jsonArray[obj].prop_id+'">'+jsonArray[obj].prop_type+'</a><!--FAMILY HOME-->'
            +'<a href="user_plot_single.jsp?prop_id='+jsonArray[obj].prop_id+'" class="propertyImgLink">'
            +' <img class="propertyImg" src="SEARCH/photo_01_'+jsonArray[obj].prop_id+'.jpg" alt="" /></a>'
            +'<h4><a href="user_plot_single.jsp?prop_id='+jsonArray[obj].prop_id+'">'+jsonArray[obj].prop_title+'</a></h4><!--587 Smith Avenue-->'
            +'<p>'+jsonArray[obj].address +'</p>'
            +'<div class="divider thin"></div>'
            +'<p class="forSale">'+jsonArray[obj].contract_type+'</p>'
            +'<p class="price">$'+jsonArray[obj].price+'</p>'
