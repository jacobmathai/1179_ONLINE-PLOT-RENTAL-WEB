...
<title>Easy Living | My Properties</title>
            ...
            <li class="dropdown menu-item-has-children">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu menu-item-has-children">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="my_properties.html" class="current-sub">My Properties</a></li>
...
<section class="genericSection">
    <div class="container">
        <a style="float:right; margin-top:-7px;" href="submit_property.html" class="buttonGrey">+ Submit New Property</a>
        <h3>MY PROPERTIES</h3>
        ...
        <table class="myProperties">
            ...
            <tr>
                <td class="myPropertyImg"><a href="property_single.html"><img class="smallThumb" src="images/blog-thumb1.jpg" alt="" /></a></td>
                <td class="myPropertyAddress"><a href="property_single.html"><h4>587 Smith Avenue</h4></a></td>
                <td class="myPropertyType">Family House</td>
                <td class="myPropertyStatus">For Sale</td>
                <td class="myPropertyDate">March 20, 2014</td>
                <td class="myPropertyActions">
                    <span><a href="edit_property.html"><img class="icon" src="images/icon-pencil.png" alt="" />EDIT</a></span>
                    <span><a href="#"><img class="icon" src="images/icon-cross.png" alt="" />REMOVE</a></span>
                    <span><a href="property_single.html"><img class="icon" src="images/icon-view.png" alt="" />VIEW</a></span>
                </td>
            </tr>
            <tr>
                <td class="myPropertyImg"><a href="property_single.html"><img class="smallThumb" src="images/blog-thumb2.png" alt="" /></a></td>
                <td class="myPropertyAddress"><a href="property_single.html"><h4>587 Smith Avenue</h4></a></td>
                <td class="myPropertyType">Family House</td>
                <td class="myPropertyStatus">Sold</td>
                <td class="myPropertyDate">March 20, 2014</td>
                <td class="myPropertyActions">
                    <span><a href="edit_property.html"><img class="icon" src="images/icon-pencil.png" alt="" />EDIT</a></span>
                    <span><a href="#"><img class="icon" src="images/icon-cross.png" alt="" />REMOVE</a></span>
            ...
            <tr>
                <td class="myPropertyImg"><a href="property_single.html"><img class="smallThumb" src="images/blog-thumb3.jpg" alt="" /></a></td>
                <td class="myPropertyAddress"><a href="property_single.html"><h4>587 Smith Avenue</h4></a></td>
                <td class="myPropertyType">Apartment</td>
                <td class="myPropertyStatus">For Rent</td>
                <td class="myPropertyDate">March 20, 2014</td>
                <td class="myPropertyActions">
                    <span><a href="edit_property.html"><img class="icon" src="images/icon-pencil.png" alt="" />EDIT</a></span>
                    <span><a href="#"><img class="icon" src="images/icon-cross.png" alt="" />REMOVE</a></span>
            ...
            <tr>
                <td class="myPropertyImg"><a href="property_single.html"><img class="smallThumb" src="images/blog-thumb4.jpg" alt="" /></a></td>
                <td class="myPropertyAddress"><a href="property_single.html"><h4>587 Smith Avenue</h4></a></td>
                <td class="myPropertyType">Condo</td>
                <td class="myPropertyStatus">For Sale</td>
                <td class="myPropertyDate">March 20, 2014</td>
                <td class="myPropertyActions">
                    <span><a href="edit_property.html"><img class="icon" src="images/icon-pencil.png" alt="" />EDIT</a></span>
