        ...
        <div class="container">
            ...
            <table class="myProperties">
                ...
                <%
                    ...
                    propertyList = new SearchModel().getUsersPropertyList(username);
                    if (propertyList.size() > 0) {
                        for (PropertyBean bean : propertyList) {
                %>
                <tr>
                    <td class="myPropertyImg"><a
                            href="user_property_single.jsp?prop_id=<%=bean.getPropertyId()%>">
                    ...
                    <td class="myPropertyActions"><span> <a
                                ...
                                href="user_property_single.jsp?prop_id=<%=bean.getPropertyId()%>"><img
