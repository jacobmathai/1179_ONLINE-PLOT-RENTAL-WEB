...
<title>Easy Living | Blog Classic</title>
...
<div class="container">
    ...
    <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown menu-item-has-children">
                <a href="blog_classic.html" class="current">BLOG</a>
                <ul class="dropdown-menu">
                    <li><a href="blog_classic.html" class="current-sub">Blog Classic</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="blogPost">
                        ...
                        <div class="propertyContent row">
                            ...
                            <table border="1" class="blogDetails">
                                <tr>
                                <td><a href="#"><img src="images/icon-date.png" alt="" style="margin-right:7px;" />12 MARCH 2014</a></td>
                                <td><a href="#"><img src="images/icon-comment.png" alt="" style="margin-right:7px;" />17 COMMENTS</a></td>
                                <td><a href="#"><img src="images/icon-heart.png" alt="" style="margin-right:7px;" />13 LIKES</a></td>
                                <td><a href="#"><img src="images/icon-share.png" alt="" style="margin-right:7px;" />SHARE</a></td>
                                </tr>
                            </table>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="blogPost">
                        <a href="blog_single.html" class="propertyImgLink"><img class="propertyImgRow" src="images/banner3.jpg" alt="" /></a>
                        <div class="propertyContent row">
                            <div class="col-lg-12 rowText">
                            <table border="1" class="blogDetails">
                                <tr>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="blogPost">
                        <a href="blog_single.html" class="propertyImgLink"><img class="propertyImgRow" src="images/bathroom.jpg" alt="" /></a>
                        <div class="propertyContent row">
                            <div class="col-lg-12 rowText">
                            <table border="1" class="blogDetails">
                                <tr>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="blogPost">
                        <a href="blog_single.html" class="propertyImgLink"><img class="propertyImgRow" src="images/banner5.jpg" alt="" /></a>
                        <div class="propertyContent row">
                            <div class="col-lg-12 rowText">
                            <table border="1" class="blogDetails">
                                <tr>
